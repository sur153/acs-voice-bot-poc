...
// Consistent SVG icons for the application
// Using inline SVGs for better performance and styling control
...
export const KeyboardIcon = ({ size = 24, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SpinnerIcon = ({ size = 24, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
